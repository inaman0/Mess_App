 ...
 */
@Component
 public class Feedback extends BaseResource {
	...
	public final static ResourceMetaData metaData = new ResourceMetaData("feedback");
	...
	static {
		...
		Field UserField = new Field("User", "String");
		UserField.setRequired(true);
		UserField.setForeign(new Foreign("User"));
		metaData.addField(UserField);
		...
		Field ImageField = new Field("Image", "String");
		metaData.addField(ImageField);
	...
	public Feedback() {this.setId(Util.getUniqueId());}
	public Feedback(String id) {this.setId(id);}
	...
	public boolean validateUser(boolean add) throws ApplicationException {
		if(add && User == null)
			throw new ApplicationException(ExceptionSeverity.ERROR, "Requierd validation Failed[User]");
		return User != null;
	}
	...
	public  Class<?> getResultClass() {return FeedbackResult.class;};
	public  Class<?> getMessageClass() {return FeedbackMessage.class;};
	public  Class<?> getHelperClass() {return FeedbackHelper.class;};
	public  Class<?> getServiceClass() {return FeedbackService.class;};
}