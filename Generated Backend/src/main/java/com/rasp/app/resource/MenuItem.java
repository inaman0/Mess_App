 ...
 */
@Component
 public class MenuItem extends BaseResource {
	...
	public final static ResourceMetaData metaData = new ResourceMetaData("menu_item");
	...
	public MenuItem(String id) {this.setId(id);}
	...
	public  Class<?> getResultClass() {return MenuItemResult.class;};
	public  Class<?> getMessageClass() {return MenuItemMessage.class;};
	public  Class<?> getHelperClass() {return MenuItemHelper.class;};
	public  Class<?> getServiceClass() {return MenuItemService.class;};
}