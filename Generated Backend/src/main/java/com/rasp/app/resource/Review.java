...
@Component
 public class Review extends BaseResource {
	...
	private String Menu_item_id = null;
	...
	public static String FIELD_MENU_ITEM_ID = "Menu_item_id";
	public static String FIELD_RATINGS = "Ratings";
	public static String FIELD_EXTRA_DATA = "extra_data";

	private static final long serialVersionUID = 1L;
	public final static ResourceMetaData metaData = new ResourceMetaData("review");
	...
	static {
		...
		Field Menu_item_idField = new Field("Menu_item_id", "String");
		Menu_item_idField.setRequired(true);
		Menu_item_idField.setForeign(new Foreign("Menu_item"));
		metaData.addField(Menu_item_idField);

		Field RatingsField = new Field("Ratings", "String");
		RatingsField.setRequired(true);
		metaData.addField(RatingsField);
		...
		metaData.setTableName("review");

		metaData.setCluster("rasp_db");
	}

	public Review() {this.setId(Util.getUniqueId());}
	public Review(String id) {this.setId(id);}

	public Review(Review obj) {
		this.id = obj.id;
		...
		this.Menu_item_id = obj.Menu_item_id;
	...
	public Map<String, Object> convertResourceToMap(HashMap<String, Object> map) {
		...
		if(Menu_item_id != null)
			map.put("Menu_item_id", Menu_item_id);
		if(Ratings != null)
	...
	public Map<String, Object> validateAndConvertResourceToMap(HashMap<String,Object> map,boolean add) throws ApplicationException {
		...
		if(validateUser_id(add))
			map.put("User_id", User_id);
		if(validateMenu_item_id(add))
			map.put("Menu_item_id", Menu_item_id);
		if(validateRatings(add))
			map.put("Ratings", Ratings);
		if(extra_data != null)
			map.put("extra_data", extra_data);
		return map;
	...
	public void convertMapToResource(Map<String, Object> map) {
		...
		Menu_item_id = (String) map.get("Menu_item_id");
		Ratings = (String) map.get("Ratings");
	...
	public void convertTypeUnsafeMapToResource(Map<String, Object> map) {
		...
		Object Menu_item_idObj = map.get("Menu_item_id");
		if(Menu_item_idObj != null)
			Menu_item_id = Menu_item_idObj.toString();

		Object RatingsObj = map.get("Ratings");
		if(RatingsObj != null)
			Ratings = RatingsObj.toString();
	...
	public String getMenu_item_idEx() {
		return Menu_item_id != null ? Menu_item_id : "";
	}
	...
	public void unSetMenu_item_id() {
		this.Menu_item_id = null;
	}

	public boolean validateMenu_item_id(boolean add) throws ApplicationException {
		if(add && Menu_item_id == null)
			throw new ApplicationException(ExceptionSeverity.ERROR, "Requierd validation Failed[Menu_item_id]");
		return Menu_item_id != null;
	}
	...
	public boolean validateRatings(boolean add) throws ApplicationException {
		if(add && Ratings == null)
			throw new ApplicationException(ExceptionSeverity.ERROR, "Requierd validation Failed[Ratings]");
		return Ratings != null;
	}
	...
	public  Class<?> getResultClass() {return ReviewResult.class;};
	public  Class<?> getMessageClass() {return ReviewMessage.class;};
	public  Class<?> getHelperClass() {return ReviewHelper.class;};
	public  Class<?> getServiceClass() {return ReviewService.class;};
}