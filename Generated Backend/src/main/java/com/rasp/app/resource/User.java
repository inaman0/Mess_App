...
@Component
 public class User extends BaseResource {
	...
	public static String FIELD_ROOM_NO = "Room_no";
	...
	static {
		...
		Field Room_noField = new Field("Room_no", "String");
		metaData.addField(Room_noField);

		Field User_typeField = new Field("User_type", "String");
		User_typeField.setEnum(true);
		User_typeField.setPossible_value("User_type");
		User_typeField.setRequired(true);
	...
	public void convertMapToResource(Map<String, Object> map) {
		...
		Room_no = (String) map.get("Room_no");
	...
	public void convertTypeUnsafeMapToResource(Map<String, Object> map) {
		...
		Object Room_noObj = map.get("Room_no");
		if(Room_noObj != null)
			Room_no = Room_noObj.toString();
	...
	public String getRoom_noEx() {
		return Room_no != null ? Room_no : "";
	}
	...
	public boolean validateUser_type(boolean add) throws ApplicationException {
		if(add && User_type == null)
			throw new ApplicationException(ExceptionSeverity.ERROR, "Requierd validation Failed[User_type]");
