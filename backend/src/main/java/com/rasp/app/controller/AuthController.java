...
public class AuthController {
    ...
    private final String keycloakUrl = "http://localhost:4000/realms/demo_realm";
    ...
    public void login(@RequestParam(value = "username", required = false) String username,
        ...
        if ("implicit".equalsIgnoreCase(authenticationType) && username != null && password != null) {
            ...
            String authUrl = "http://localhost:4000/realms/demo_realm/protocol/openid-connect/auth"
                    + "?client_id=" + clientId
                    + "&response_type=code"
    ...
    private void handleImplicitFlow(String username, String password, HttpServletResponse response) {
        ...
        setCookie(response, "access_token", accessToken, 86400); // 24 hours expiry
...
//        return ResponseEntity.ok("Login successful");
    ...
    public ResponseEntity<String> addUser(@RequestParam String adminUsername,
        ...
        ResponseEntity<Map> tokenResponse = restTemplate.exchange(
                "http://localhost:4000/realms/master/protocol/openid-connect/token",
                HttpMethod.POST,
                tokenRequest,
                Map.class
        );
        ...
        ResponseEntity<String> userResponse = restTemplate.exchange(
                "http://localhost:4000/admin/realms/demo_realm/users",
                HttpMethod.POST,
                userRequest,
                String.class
        );
...
baseResource.convertMapToResource(map);
        ...
        HttpEntity<MultiValueMap<String, String>> tokenRequest = new HttpEntity<>(tokenRequestBody, headers);
        ResponseEntity<Map> tokenResponse = restTemplate.exchange(
                "http://localhost:4000/realms/demo_realm/protocol/openid-connect/token",
                HttpMethod.POST,
                tokenRequest,
                Map.class
        );
...
//        HttpEntity<MultiValueMap<String, String>> tokenRequest = new HttpEntity<>(tokenRequestBody, headers);
//        ResponseEntity<Map> tokenResponse = restTemplate.exchange(
//                "http://localhost:4000/realms/new/protocol/openid-connect/token",
//                HttpMethod.POST,
//                tokenRequest,
//                Map.class
//        );
...
//                "http://localhost:4000/admin/realms/new/clients",
//                HttpMethod.GET,
//                clientRequest,
//                List.class
//        );
...
//                "http://localhost:4000/admin/realms/new/clients/" + clientUUID + "/roles",
//                HttpMethod.POST,
//                roleRequest,
//                String.class
//        );
...
//```java
    ...
    public ResponseEntity<String> assignClientRole(
        ...
        ResponseEntity<List> userResponse = restTemplate.exchange(
                "http://localhost:4000/admin/realms/demo_realm/users?username=" + username,
                HttpMethod.GET,
                userRequest,
                List.class
        );
        ...
        ResponseEntity<List> clientResponse = restTemplate.exchange(
                "http://localhost:4000/admin/realms/demo_realm/clients?clientId=" + clientId,
                HttpMethod.GET,
                userRequest,
                List.class
        );
        ...
        ResponseEntity<List> roleResponse = restTemplate.exchange(
                "http://localhost:4000/admin/realms/demo_realm/clients/" + clientUuid + "/roles",
                HttpMethod.GET,
                userRequest,
                List.class
        );
        ...
        ResponseEntity<String> assignRoleResponse = restTemplate.exchange(
                "http://localhost:4000/admin/realms/demo_realm/users/" + userId + "/role-mappings/clients/" + clientUuid,
                HttpMethod.POST,
                assignRoleRequest,
                String.class
        );
    ...
    public ResponseEntity<String> logout(@CookieValue(value = "refresh_token", required = false) String refreshToken, HttpServletResponse response) {
        ...
        try {
            restTemplate.postForEntity("http://localhost:4000/realms/demo_realm/protocol/openid-connect/logout", request, String.class);
