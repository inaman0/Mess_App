 ...
 */
 public class FeedbackHelper extends BaseHelper {
		public FeedbackHelper() {super(new Feedback());}
		private static FeedbackHelper instance;
		public static FeedbackHelper getInstance() {if (instance == null)	{instance = new FeedbackHelper();register_birecord();} return instance;}
