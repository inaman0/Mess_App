 ...
 */
 public class ReviewHelper extends BaseHelper {
		public ReviewHelper() {super(new Review());}
		private static ReviewHelper instance;
		public static ReviewHelper getInstance() {if (instance == null)	{instance = new ReviewHelper();register_birecord();} return instance;}
