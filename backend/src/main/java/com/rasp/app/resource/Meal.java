 ...
 */
@Component
 public class Meal extends BaseResource {
	...
	public final static ResourceMetaData metaData = new ResourceMetaData("meal");
	...
	static {
		...
		Field Meal_typeField = new Field("Meal_type", "String");
		Meal_typeField.setEnum(true);
		Meal_typeField.setPossible_value("Meal_type");
		...
		metaData.setTableName("meal");

		metaData.setCluster("rasp_db");
	}

	public Meal() {this.setId(Util.getUniqueId());}
	public Meal(String id) {this.setId(id);}
	...
	public void convertTypeUnsafeMapToResource(Map<String, Object> map) {
		...
		Object Meal_typeObj = map.get("Meal_type");
	...
	public String getMeal_typeEx() {
		return Meal_type != null ? Meal_type : "";
	}
	...
	public void unSetMeal_type() {
		this.Meal_type = null;
	}

	public boolean validateMeal_type(boolean add) throws ApplicationException {
		if(add && Meal_type == null)
			throw new ApplicationException(ExceptionSeverity.ERROR, "Requierd validation Failed[Meal_type]");
	...
	public  Class<?> getResultClass() {return MealResult.class;};
	public  Class<?> getMessageClass() {return MealMessage.class;};
	public  Class<?> getHelperClass() {return MealHelper.class;};
	public  Class<?> getServiceClass() {return MealService.class;};
}