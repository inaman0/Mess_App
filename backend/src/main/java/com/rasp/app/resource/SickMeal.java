 ...
 */
@Component
 public class SickMeal extends BaseResource {
	...
	public final static ResourceMetaData metaData = new ResourceMetaData("sick_meal");
	...
	static {
		...
		Field Meal_idField = new Field("Meal_id", "String");
		Meal_idField.setRequired(true);
		...
		metaData.setTableName("sick_meal");

		metaData.setCluster("rasp_db");
	}

	public SickMeal() {this.setId(Util.getUniqueId());}
	public SickMeal(String id) {this.setId(id);}

	public SickMeal(SickMeal obj) {
		this.id = obj.id;
	...
	public void convertTypeUnsafeMapToResource(Map<String, Object> map) {
		...
		Object Meal_idObj = map.get("Meal_id");
		if(Meal_idObj != null)
	...
	public String getMeal_idEx() {
		return Meal_id != null ? Meal_id : "";
	}
	...
	public void unSetMeal_id() {
		this.Meal_id = null;
	}

	public boolean validateMeal_id(boolean add) throws ApplicationException {
		if(add && Meal_id == null)
			throw new ApplicationException(ExceptionSeverity.ERROR, "Requierd validation Failed[Meal_id]");
		return Meal_id != null;
	}
	...
	public  Class<?> getResultClass() {return SickMealResult.class;};
	public  Class<?> getMessageClass() {return SickMealMessage.class;};
	public  Class<?> getHelperClass() {return SickMealHelper.class;};
	public  Class<?> getServiceClass() {return SickMealService.class;};
}