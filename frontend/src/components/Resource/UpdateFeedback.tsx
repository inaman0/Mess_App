...
const getCookie = (name: string): string | null => {
  ...
  if (!accessToken) {
   ...
   queryFn: async () => {
    ...
    navigate('/edit',{state:{id:id,editedData:editedData,resourceName:'Feedback',currUrl:currentUrl,apiUrl:apiUrl.toString(),metadataUrl:metadataUrl.toString(),BaseUrl:BaseUrl.toString()}});
};
